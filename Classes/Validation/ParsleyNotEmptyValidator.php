 ...
 ***/
 ...
 /**
  * ParsleyNotEmptyValidator
  */
class ParsleyNotEmptyValidator implements FrontendValidatorInterface
{
    public function __invoke(FormElementInterface $formElement, ValidatorInterface $validator): void
    {
        ...
        FormElementUtility::addAttribute($formElement, 'data-parsley-required', 'true');
        FormElementUtility::addAttribute($formElement, 'data-parsley-required-message', FormElementUtility::getErrorMessage($formElement, 1221560910));
    }
}
