 ...
 ***/
 ...
 /**
  * ParsleyNumberValidator
  */
class ParsleyNumberValidator implements FrontendValidatorInterface
{
    public function __invoke(FormElementInterface $formElement, ValidatorInterface $validator): void
    {
        ...
        FormElementUtility::addAttribute($formElement, 'data-parsley-type', 'number');
        FormElementUtility::addAttribute($formElement, 'data-parsley-error-message', FormElementUtility::getErrorMessage($formElement, 1221563685));
    }
}
