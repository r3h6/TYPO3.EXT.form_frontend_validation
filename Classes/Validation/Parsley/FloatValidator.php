...
final class FloatValidator implements FrontendValidatorInterface
{
    public function __invoke(FormElementInterface $formElement, ?ValidatorInterface $validator = null): void
    {
        ...
        FormElementUtility::addAttribute($formElement, 'data-parsley-pattern-message', FormElementUtility::getErrorMessage($formElement, 1221560288));
    }
}
