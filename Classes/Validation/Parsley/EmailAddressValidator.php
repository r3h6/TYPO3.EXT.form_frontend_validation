...
final class EmailAddressValidator implements FrontendValidatorInterface
{
    public function __invoke(FormElementInterface $formElement, ?ValidatorInterface $validator = null): void
    {
        ...
        FormElementUtility::addAttribute($formElement, 'data-parsley-type-message', FormElementUtility::getErrorMessage($formElement, 1221559976));
    }
}
